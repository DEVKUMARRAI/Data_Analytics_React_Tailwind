    ...
    return (
        <div className="text-white">
            <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
                ...
                <h1 className="md:text-7xl sm:text-6xl text-4xl font-bold md:py-6">Grow With Datad</h1>
                ...
                <button className="bg-[#00df9a] w-[200px] rounded-md mx-auto my-6 py-3 text-black">
                    Get Started
                </button>
            </div>
        </div>
